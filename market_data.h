...
struct IncreamentalPacketHeader { // Little endian
    ...
    static IncreamentalPacketHeader parse(std::ifstream& file, Endian endian) {
        return IncreamentalPacketHeader {
...
std::ostream& operator<<(std::ostream& os, const IncreamentalPacketHeader& header) {
